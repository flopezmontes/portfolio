...
const About = () => {
  ...
  <div className="flex p-20 background-image">
    <div>
      ...
      >
        I am a software engineer with wide experience in web and data integration
        development, both backend and frontend. Passionate about sport, nature and coding.
