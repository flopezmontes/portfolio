  ...
  >
    ...
    <div className='mt-1'>
      ...
      <div className='mt-7 flex justify-between items-center gap-1'>
        ...
        <div className='absolute inset-0 flex justify-end m-9 card-img_hover'>
          <div onClick={() => window.open(source_pdf, "_blank")}
    ...
    <div className={`mt-12 bg-black-100 rounded-[20px]`}>
      ...
      >
        <motion.div variants={textVariant()}>
          ...
          <p className={styles.sectionSubText}>Click to read full reference letter</p>
        </motion.div>
      </div>
